...
## Usage
Open any playlist in new tab (not modal window) you want to export. Run [this script](https://raw.githubusercontent.com/anddea/export-vk-music/main/vk.js) or [copy code below](#copy-code) and paste it in browser console.  
