# Export VK music
From any playlist and save multiple ways.

## Usage
Open any playlist you want to export in new tab (not modal window). Run [this script](https://raw.githubusercontent.com/anddea/export-vk-music/main/vk.js) or [copy code below](#copy-code) and paste it in browser console.  
